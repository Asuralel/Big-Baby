<?php
    ...
    $user_sign = isset($_REQUEST['tel']) ? $_REQUEST['tel'] : '快去设置你的个性签名吧！';
    ...
    $user_address = isset($_REQUEST['user_address']) ? $_REQUEST['user_address'] : '您还没有收货地址哦';
    ...
    $user_account = isset($_REQUEST['tel']) ? $_REQUEST['tel'] : "big-baby".$tel;
    ...
    if(sizeof(query($sql))>0){
        ...
        $sql = "insert into users (user_name,user_password,user_phone,user_id,user_sign, user_collect,user_gender,user_address,head_image,user_order,user_account) values('$username','$password','$tel','$user_id','$user_sign','$user_collect','$user_gender','$user_address','$head_image','$user_order','$user_account')";
